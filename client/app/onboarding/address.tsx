...
export default function SignUp() {
  ...
  const accountSignUp = async () => {
    ...
    const { data, error } = await supabase.auth.signUp({
      ...
      options: {
        data: {
          first_name: await AsyncStorage.getItem("signup_firstname"),
          last_name: await AsyncStorage.getItem("signup_lastname"),
          user_type: await AsyncStorage.getItem("signup_usertype"),
          username: await AsyncStorage.getItem("signup_username"),
          street: await AsyncStorage.getItem("signup_street"),
          region: await AsyncStorage.getItem("signup_regionname"),
          province: await AsyncStorage.getItem("signup_provincename"),
          city: await AsyncStorage.getItem("signup_cityname"),
          barangay: await AsyncStorage.getItem("signup_brgyname"),
          zipcode: await AsyncStorage.getItem("signup_zipcode"),
        },
      },
    });
